...
const fleet = { ships: { "trade-ship": 1, galley: 0 }, labels: { "trade-ship": "Pentekonter", galley: "Trireme" }, range: 7, space: 20, tiers: [{ range: 7, space: 20 }] };
...
describe("move picker", () => {
  ...
  it("a sea move short of hulls reads the hull reason; the destination base itself cannot be the origin", () => {
    ...
    expect(sea.container.querySelector(".w2map-verdict")!.textContent).toContain("space 40 of 20 aboard · 1 pentekonter");
